...
static vk_state_t g_vk = {0};

static void vk_set_error_text(const char *text)
{
    snprintf(g_vk.error, sizeof(g_vk.error), "%s", text);
}

static void vk_set_error_result(const char *what, VkResult result)
{
    snprintf(g_vk.error, sizeof(g_vk.error), "%s failed (vk=0x%08X).", what, (unsigned)result);
}

static void vk_set_hdr_status_text(const char *text)
{
...
static void vk_update_hdr_status(bool has_hdr10_candidate)
{
...
static bool vk_has_instance_extension(const char *name)
{
    uint count = 0;
    VkResult result;
...
static void vk_destroy_device_shader_resources(void)
{
...
static bool vk_create_device_shader_resources(void)
{
...
static void vk_pack_surface(const f32x4_surface_t *surface)
{
...
static void vk_destroy_swapchain_resources(void)
{
...
static bool vk_create_swapchain_resources(void)
{
...
static bool vk_record_present_commands(uint image_index)
{
