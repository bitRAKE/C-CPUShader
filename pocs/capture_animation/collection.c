...
static const shader_desc_t g_shaders[] = {
    ANIMATED_SPRITE_SHADER(ENTRY)
    CRYSTAL_DODECAHEDRON_SHADER(ENTRY)
    ORBIT_STARS_SHADER(ENTRY)
};
...
{
    g_info.collection_name    = "Capture Animation";
    g_info.collection_version = "1.0";
    g_info.collection_blurb   = "Frame-driven animation studies for capture and timing work.";
