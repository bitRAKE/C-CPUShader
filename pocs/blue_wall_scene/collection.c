...
static const shader_desc_t g_shaders[] = {
    BLUE_WALL_V2_A_SHADER(ENTRY)
    BLUE_WALL_V2_B_SHADER(ENTRY)
    BLUE_WALL_V2_C_SHADER(ENTRY)
    BLUE_WALL_V2_D_SHADER(ENTRY)
    BLUE_WALL_V2_E_SHADER(ENTRY)
};
...
{
    g_info.collection_name    = "Blue Wall Scene";
    g_info.collection_version = "1.0";
    g_info.collection_blurb   = "Progressive ray-traced interior scene reconstruction from Blender extraction.";
