/* Generated Stage A view for Blue Wall scene reconstruction. */
#pragma once
...
enum { BLUE_WALL_STAGE_A_GROUP_COUNT_V2 = 3 };
static const blue_wall_stage_group_t g_blue_wall_stage_A_groups_v2[BLUE_WALL_STAGE_A_GROUP_COUNT_V2] = {
    {
        "room_shell",
        "Room Shell",
        "room_shell",
