/* Generated Stage D view for Blue Wall scene reconstruction. */
#pragma once
...
enum { BLUE_WALL_STAGE_D_GROUP_COUNT_V2 = 13 };
static const blue_wall_stage_group_t g_blue_wall_stage_D_groups_v2[BLUE_WALL_STAGE_D_GROUP_COUNT_V2] = {
    {
        "room_shell",
        "Room Shell",
        "room_shell",
